...
class ListAllProductsIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        # else:
        #     speech_text = "I'm not sure how to help with that."
        return handler_input.response_builder.speak(speech_text).response
...
# def add_item_to_list(item, userid):
#     response = table.get_item(Key={'UserId': userid})
#     shopping_list = response.get('Item', {}).get('ShoppingList', [])
#     shopping_list.append(item)
#     table.put_item(Item={'UserId': userid, 'ShoppingList': shopping_list})
#     # table.put_item(Item={userid: item})

# def get_shopping_list(userid):
#     response = table.get_item(Key={'UserId': userid})
#     shopping_list = response.get('Item', {}).get('ShoppingList', [])
#     return shopping_list

# def remove_item_from_list(item, userid):
#     response = table.get_item(Key={'UserId': userid})
#     shopping_list = response.get('Item', {}).get('ShoppingList', [])
